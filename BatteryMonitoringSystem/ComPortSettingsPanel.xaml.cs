...
{
    /// <summary>
    /// Interaction logic for ComPortSettingsPanel.xaml
    /// </summary>
    public partial class ComPortSettingsPanel : UserControl
    {
        ...
        public static readonly DependencyProperty IsPressedProperty =
            DependencyProperty.Register("IsPressed", typeof(bool), typeof(ComPortSettingsPanel),
        ...
        {
            ComPortSettingsPanel panel = (ComPortSettingsPanel)depObj;
        ...
        private static void RemoveUserControl(ComPortSettingsPanel panel)
        {
            var parent = (Panel)LogicalTreeHelper.GetParent(panel);
            parent.Children.Remove(panel);
        }

        private void ComPortSettingsPanel_Loaded(object sender, RoutedEventArgs e)
        {
            ThicknessAnimation animate = new ThicknessAnimation()
            {
